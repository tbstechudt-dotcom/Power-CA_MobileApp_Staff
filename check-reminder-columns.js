...
async function checkColumns() {
  try {
    // Get column names for reminder table
    ...
    console.log('Columns in reminder table:');
    console.log('============================');
    ...
    const columnsWeUse = ['rem_id', 'remid', 'rem_date', 'remdate', 'rem_status', 'remstatus', 'staff_id', 'staffid'];
