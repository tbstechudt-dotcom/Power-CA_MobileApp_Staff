...
android {
    namespace = "com.powerca.mobile"
    compileSdk = 36  // Android 16 / Latest SDK for plugin compatibility
    ...
    defaultConfig {
        ...
        minSdk = 24  // Android 7.0+ (wider compatibility)
        targetSdk = 35  // Android 15 target
