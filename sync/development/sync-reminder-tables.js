/**
 * Sync reminder and remdetail tables only
 */
...
async function main() {
  try {
    console.log('='.repeat(70));
    console.log('SYNCING REMINDER TABLES');
    console.log('='.repeat(70));
    ...
    console.log('\nNOTE: taskchecklist was skipped due to data model mismatch');
    console.log('      (Desktop has generic templates, mobile expects job-specific instances)');
    console.log('='.repeat(70));
