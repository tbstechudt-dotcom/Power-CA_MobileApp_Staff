...
const config = {
  ...
  columnMappings: {
    ...
    jobtasks: {
      // SKIP jt_id - Mobile-only tracking column, NOT in desktop
      // Desktop doesn't have jt_id, mobile auto-generates it for tracking
      skipColumns: ['jt_id'],
      addColumns: {
        source: 'D',
        created_at: () => new Date(),
    ...
    // KEEP rem_id - Desktop PK, preserve from desktop
    mbreminder: {
      skipColumns: [], // Keep rem_id from desktop
      addColumns: {
        source: 'D',
        created_at: () => new Date(),
        updated_at: () => new Date(),
    ...
    // KEEP remd_id - Desktop PK, preserve from desktop
    mbremdetail: {
      skipColumns: [], // Keep remd_id from desktop
      addColumns: {
        source: 'D',
        created_at: () => new Date(),
        updated_at: () => new Date(),
